...
//             <p className="mt-1 text-[16px] text-[#7C7C7C]">
//               {product.unit}, Price
//             </p>
//           </div>
...
//                 )
//               }
//               className="text-3xl text-[#B3B3B3]"
//             >
//               −
//             </button>
...
//               }
//               className="text-3xl text-[#53B175]"
//             >
//               +
//             </button>
//           </div>
...
//             <span className="rounded-md bg-[#EBEBEB] px-2 py-1 text-xs text-[#7C7C7C]">
//               100gr
//             </span>
...
//         {/* BUTTON */}
//         <button className="mb-8 mt-4 h-[67px] w-full rounded-[19px] bg-[#53B175] text-[18px] font-semibold text-white">
//           Add To Basket
//         </button>
//       </div>
//     </div>
